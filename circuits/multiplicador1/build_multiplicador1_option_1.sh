...
echo ">>>>Se genera error ya que las restricciones definidas en el circuito no permiten que ninguna de las dos señales de entrada tengan un valor de 1, ya que esto generaría un valor indefinido<<<<"
start=`date +%s`
